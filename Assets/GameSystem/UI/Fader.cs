...
public class Fader : MonoBehaviour
{
    ...
    private BossScript bossScriptManager;
    ...
    void Start()
    {
        ...
        bossScriptManager = bossScript.GetComponent<BossScript>();
    ...
    void Update()
    {
        if (bossScriptManager.IsFadeStart()==true)
        {
            StartFadeIn(); 
        }
        if (bossScriptManager.IsFadeStart() == false)
        {
            StartFadeOut();      
        }
    }
